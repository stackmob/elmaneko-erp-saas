...
export function useFilamentsData() {
  ...
  const useAddCompra = () => {
    return useMutation({
      mutationFn: async (nova: Omit<Purchase, 'id'>) => {
        ...
        // Auto-link: Lançamento Financeiro de Despesa
        try {
