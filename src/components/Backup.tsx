...
export default function BackupModule() {
  ...
  const ENTITIES_CONFIG = [
    ...
    { key: 'centros_custo', label: 'Centros de Custo', table: 'centros_custo', tableExists: true, hasTenantFilter: true },
  ...
  const handleFreezeV1 = async () => {
    ...
    try {
      ...
      // Temporary package to compute raw hash
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <h2 className="text-xl font-bold text-white tracking-tight mt-2">
            Congelar Cópia da Base v1 (Exportação Estruturada & SHA-256)
          </h2>
          <p className="text-sm text-neutral-400 mt-1">
            Exporte todas as entidades do banco em formato JSON/CSV padronizado, calcule o hash criptográfico de integridade e defina a empresa de destino na v2.
          </p>
        </div>
      </div>
